                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($education_and_career_data[0]['education_detail'])){
                                        echo $education_and_career_data[0]['education_detail'];
                                    }
                                ?>
                            ...
                            <td>
                                <?php 
                                    if(!empty($education_and_career_data[0]['occupation_detail'])){
                                        echo $education_and_career_data[0]['occupation_detail'];
                                    }
                                ?>
                            </td>
                        </tr>
