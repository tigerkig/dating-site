                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($basic_info_data[0]['marital_status'])){
                                        echo $this->Crud_model->get_type_name_by_id('marital_status', $basic_info_data[0]['marital_status']);
                                    }
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($basic_info_data[0]['child_count'])){
                                        echo $this->Crud_model->get_type_name_by_id('child_count', $basic_info_data[0]['child_count']);
                                    }
                                ?>
                            </td>
                            <td class="td-label">
                        ...
                        <tr>
                            ...
                            <td>
                                 <?php 
                                    if( !empty($basic_info_data[0]['caste']) ){
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($basic_info_data[0]['p_height'])){
                            ...
                            <td>
                                <?php
                                if(!empty($basic_info_data[0]['religion'])){
