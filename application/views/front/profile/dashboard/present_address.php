                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($present_address_data[0]['address'])){
                                        echo $present_address_data[0]['address'];
                                    }
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($present_address_data[0]['mobile2'])){
                                        echo $present_address_data[0]['mobile2'];
                                    }
                                ?>                                
                            </td>
                        </tr>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            $_residence = !empty($get_member[0]->residence) ? $get_member[0]->residence : '';
                            echo $this->Crud_model->select_new_html('residence', 'residence', 'display', 'edit', 'form-control form-control-sm selectpicker ', $_residence, '', '', '');                            
                        ?>                        
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
