                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($family_info_data[0]['father_name'])){
                                        echo $family_info_data[0]['father_name'];
                                    }
                                ?>
                            </td>
                            <td class="td-label">
                            ...
                            <td>
                                <?php 
                                    if(!empty($family_info_data[0]['mother_name'])){
                                        echo $family_info_data[0]['mother_name'];
                                    }
                                ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <?php 
                                    if(!empty($family_info_data[0]['father_occupation'])){
                                        echo $family_info_data[0]['father_occupation'];
                                    }
                                ?>
                            </td>
                            <td class="td-label">
                            ...
                            <td>
                                <?php 
                                    if(!empty($family_info_data[0]['mother_occupation'])){
                                        echo  $family_info_data[0]['mother_occupation'];
                                    }
                                ?>
                            </td>
                        </tr>
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input  type="text" class="form-control no-resize" 
                                name="mother" 
                                value="<?php 
                                            if(!empty($family_info_data[0]['mother'])){
