				...
				<div class="panel">
					<div class="panel-body">
				        ...
				        <div class="panel panel-dark">
				            ...
				            <div class="panel-body">
	                            ...
	                            <div class="row">
	                            	<div class="col-md-6">
	                            	    <div class="form-group has-feedback">
	                            	        <label class="text-uppercase c-gray-light">
	                            	        	Password<span class="text-danger">*</span>
	                            	        </label>
	                            	        <label class="text" style="float: right;" id="show_form">
	                            	        	<a href="javascript:show_form()" class="btn btn-dark">Show Form</a>
	                            	        </label>
	                            	        <div id="password-div" class="hidden">
		                            	        ...
		                            	        <div>
		                            	    		<a href="javascript:reset_password_form(<?= $value->member_id?>)" class="btn btn-primary" style="margin-top: 20px;">Reset Password</a>   	
		                            	        </div>
	                            	        </div>
	                            	    </div>
	                            	</div>
	                            	<div class="col-md-6">
	                            		<label></label>
	                            	    <!-- <a href="javascript:void(0)" class="btn btn-primary">Reset Password</a> -->
	                            	</div>
	                            </div>
	                            <!-- << end of pass -->
	                            <div class="row">
				        ...
				        <?php
							...
							$life_style = $this->Crud_model->get_type_name_by_id('member', $value->member_id, 'life_style');
	                    ...
	                    <?php
							...
							$astronomic_information = $this->Crud_model->get_type_name_by_id('member', $value->member_id, 'astronomic_information');
...
<script>
	...
	function reset_password_form(member_id){
		let pass = $('input[name="password"]').val();
		let re_pass = $('input[name="retype_password"]').val();

		if(pass != re_pass || !pass){
			alert('Invalid password or Not matched retype password!'); 
			return;
		}
		debugger
		$.ajax({
			...
			type: 'post',
			dataType: 'json',
			data: {'password': pass, 'member_id' : member_id},
			success: function(data){
				
				if(data.res.success){
					alert(data.res.msg);
				}else{
					alert('Caution !' + data.res.msg);
				}
