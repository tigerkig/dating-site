					...
					?>
						<?php
							foreach ($member as $value) {
								...
								$language = !empty($value->language) ? json_decode($value->language, true) : '';
								$hobbies_and_interest = !empty($value->hobbies_and_interest) ? json_decode($value->hobbies_and_interest, true) : '';
								$personal_attitude_and_behavior = !empty($value->personal_attitude_and_behavior) ? json_decode($value->personal_attitude_and_behavior, true) : '';
								$residency_information = !empty($value->residency_information) ? json_decode($value->residency_information, true) : '';
								$spiritual_and_social_background = !empty($value->spiritual_and_social_background) ? json_decode($value->spiritual_and_social_background, true) : '';
								$life_style = !empty($value->life_style) ? json_decode($value->life_style, true) : '';
								$astronomic_information = !empty($value->astronomic_information) ? json_decode($value->astronomic_information, true) : '';
								$permanent_address = !empty($value->permanent_address) ? json_decode($value->permanent_address, true) : '';
								$family_info = !empty($value->family_info) ? json_decode($value->family_info, true) : '';
								$additional_personal_details = !empty($value->additional_personal_details) ? json_decode($value->additional_personal_details, true) : '';
								$partner_expectation = !empty($value->partner_expectation) ? json_decode($value->partner_expectation, true) : '';
							}
