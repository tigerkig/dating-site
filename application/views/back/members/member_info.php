				...
				<div class="panel-body">
			        ...
			        <div class="panel panel-dark">
			            ...
			            <div class="panel-body">
							...
							<tr>
								<td><b>Password</b></td>
								<td id="show_pass_hide"><b>******</b></td>
								<td id="show_pass" class="hidden">
									<b><?= $value->orig_password ?></b>
								</td>
								<td><button onclick="show_pass()">Show Password</button></td>
							</tr>
							<tr>
								<td>
...
<script>
	...
	function show_pass(){
		if (window.confirm("Do you really want to see the password?")) {
			$('#show_pass').removeClass('hidden');
			$('#show_pass_hide').addClass('hidden');
		}
	}
</script>
