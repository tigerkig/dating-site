<?php 
	...
	foreach ($member as $value) {
		...
		$personal_attitude_and_behavior = !empty($value->personal_attitude_and_behavior) ?
                                          json_decode($value->personal_attitude_and_behavior, true) : '';
		$residency_information = !empty($value->residency_information) ? json_decode($value->residency_information, true) : '';

		$spiritual_and_social_background = !empty($value->spiritual_and_social_background) ?
                                            json_decode($value->spiritual_and_social_background, true) : '';
